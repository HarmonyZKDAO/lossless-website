      ...
      <nav className='justify-end items-center hidden sm:flex w-2/3'>
        ...
        >
          ...
          <a
            ...
            className='rounded-lg border-2 text-green border-green bg-default px-5 py-1 text-lg font-semibold hover:text-purple hover:bg-green transition-colors duration-300 ease-in-out'
          >
            App
          </a>
        </Link>
